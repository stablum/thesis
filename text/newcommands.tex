...
\newcommand{\sumj}[1]{\sum_{j=1}^J #1}
\newcommand{\prodj}[1]{\prod_{j=1}^J #1}
\newcommand{\prodjprime}[1]{\prod_{j^\prime=1}^J #1}
...
\newcommand{\boldSigma}{\mathbf{\Sigma}}
...
\newcommand{\qphizcond}{q_\phi\left(\zcond\right)}
...
\newcommand{\rij}{r_{ij}}
\newcommand{\expectqph}[1]{\expect{\qphizcond}{#1}}
\newcommand{\expectqphi}[1]{\expect{\qphizcondi}{#1}}
\newcommand{\expectqphiZ}[1]{\expect{\qphiZ}{#1}}
\newcommand{\expectxM}[1]{\expect{\boldx\sim\mathcal{M}}{#1}}
\newcommand{\expectx}[1]{\expect{\boldx}{#1}}
...
\newcommand{\qzonly}{\qphi{\boldz}}
\newcommand{\logqzcond}{\log \qzcond}
...
\newcommand{\diffximutheta}{\left(\boldxi - \boldmu_\theta\right)}
\newcommand{\diffxijmuthetaj}{\left(\xij - \mu_{\theta j}\right)}
\newcommand{\diffTxizerotheta}{\left(\tr(\boldzzero) - \boldzero\right)}
